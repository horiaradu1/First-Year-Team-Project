...
<body>
  ...
  <div class="container">
    ...
    <div class="row text-center" style="padding-top: 10px">
      ...
      <div class="col-md-4">
        <button class="btn btn-info custom-btn btn-lg btn-block align-items-center">CREATE COURSE</button>
      </div>
      <div class="col-md-4">
        <button class="btn btn-info custom-btn btn-lg btn-block align-items-center">CREATE EVENT</button>
      </div>
      <div class="col-md-1">
