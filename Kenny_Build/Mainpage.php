...
<body>
  ...
  <div class="container">
    ...
    <div class="row text-center" style="padding-top: 10px">
      ...
      <div class="col-md-1">
        <span style="color: #023858;">
        <a href="/g34904ps/team/HTML/moreTable.php?week=<?php $week += 2; echo $week; ?> " class="previous round"><i class="fas fa-arrow-alt-circle-right fa-3x align-items-center"></i></a>
        </span>
      </div>
    </div>
