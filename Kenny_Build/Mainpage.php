...
<body>
  ...
  <div class="container">
    ...
    <div class="row text-center">
      ...
      <div class="col-md-4 pink d-flex">
        <button class="btn btn-info btn-lg align-items-center">CREATE COURSE</button>
      </div>
      <div class="col-md-4 pink d-flex">
        <button class="btn btn-info btn-lg align-items-center">CREATE EVENT</button>
      </div>
