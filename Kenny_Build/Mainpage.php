  ...
  <div class="container">
    ...
    <div class="row text-center">
      ...
      <div class="col-md-4 pink">
        <button class="btn btn-info btn-lg align-items-center d-flex">CREATE COURSE</button>
      </div>
      <div class="col-md-4 pink">
        <button class="btn btn-info btn-lg align-items-center d-flex">CREATE EVENT</button>
      </div>
