  ...
  <div class="container">
    ...
    <div class="row text-center" style="padding-top: 10px">
      <div class="col-md-1 offset-md-1">
          <a style="color: #132f57;" href="/g34904ps/team/Kenny_Build/moreTable.php?week=<?php $week -= 1; echo $week; ?>"><i class="fas fa-arrow-alt-circle-left fa-3x align-items-center"></i></a>
      </div>
      <div class="col-md-4">
