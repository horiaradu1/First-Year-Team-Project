  ...
  <div class="container">
    ...
    <div class="row text-center" style="padding-top: 10px">
      <div class="col-md-1 offset-md-1">
          <a class="btn-infoX" href="/g34904ps/team/FinalProject/moreTable.php?week=<?php $week -= 1; echo $week; ?>"><i class="fas fa-arrow-alt-circle-left fa-3x align-items-center"></i></a>
      </div>
      <div class="col-md-4">
      ...
      <div class="col-md-1">
        <span> 
          <a class="btn-infoX" href="/g34904ps/team/FinalProject/moreTable.php?week=<?php $week += 2; echo $week; ?>"><i class="fas fa-arrow-alt-circle-right fa-3x align-items-center"></i></a>
        </span>
      </div>
    </div>
    ...
    <div id="popup1" class="overlay">
      <div class="popup1 form1" style= "height: 520px;">
        <form method=POST>
          ...
          <div>
            <select id = "sel" name="new_course" class="form-control form-control-lg">
