  ...
  <div class="container">
    ...
    <div class="row text-center" style="padding-top: 10px">
      <div class="col-md-1 offset-md-1">
          <a href="/g34904ps/team/FinalProject/Mainpage.php?week=<?php $week -= 1; echo $week; ?>"><i class="fas fa-arrow-alt-circle-left fa-3x align-items-center"></i></a>
      </div>
      <div class="col-md-4">
      ...
      <div class="col-md-1">
        <span style="color: #023858;"> 
          <a href="/g34904ps/team/FinalProject/Mainpage.php?week=<?php $week += 2; echo $week; ?>"><i class="fas fa-arrow-alt-circle-right fa-3x align-items-center"></i></a>
        </span>
      </div>
    </div>
